...
export const Iuran = () => {
  ...
  return (
    <div className=''>
      ...
      <div>
        <div className='mt-4 bg-red-100 w-fit px-8 py-3 text-red-600 rounded-full font-medium'>
          Kamu belum membayar iuran minggu ke-4
        </div>
      </div>

      <div className='mt-4 bg-white rounded-lg px-6 py-4 grid grid-cols-2 gap-4'>
        <div>
            ...
            <button className='flex items-center gap-2 rounded-md bg-gray-100 p-3 w-full justify-between'>
              ...
              {selectedPayment === "gopay" && (
                <button onClick={() => setSelectedPayment("")}>
                  <BiXCircle className='text-red-600' />
                </button>
              )}
            </button>
            <button className='flex items-center gap-2 rounded-md bg-gray-100 p-3 w-full justify-between'>
